...
std::vector<std::string> ParentRoutine(const std::vector<std::string> &input)
{
    ...
    sem_t *sem1 = sem_open("1", O_CREAT, S_IRUSR | S_IWUSR, 0);
    sem_t *sem2 = sem_open("2", O_CREAT, S_IRUSR | S_IWUSR, 1);
    sem_t *sem3 = sem_open("3", O_CREAT, S_IRUSR | S_IWUSR, 0);
    sem_t *sem4 = sem_open("4", O_CREAT, S_IRUSR | S_IWUSR, 1);
